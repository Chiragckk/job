...
const JobCard = ({job}) => {
  ...
  return (
    <div className='border-gray-300 p-6 shadow rounded'>
     ...
     <div className='mt-4 flex gap-4 text-sm'>
        ...
        <button onClick={()=>{navigate(`/apply-job/${job._id}`); scrollTo(0,0)}} className='text-gray-600 border border-gray-600 rounded px-4 py-2'>Learn more</button>
     </div>
    </div>
  )
}
