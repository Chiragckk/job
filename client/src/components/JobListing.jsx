      ...
      <section className='w-full lg:w-3/4 text-gray-800 max-lg:px-4'>
        ...
        {filteredJobs.length > 0 && (
          <div className='flex items-center justify-center space-x-2 mt-10'>
            <a href="#job-list">
              <img onClick={() => setCurrentPage(Math.max(currentPage - 1, 1))} src={assets.left_arrow_icon} alt="prev" />
            </a>
            {
            ...
            <a href="#job-list">
              <img onClick={() => setCurrentPage(Math.min(currentPage + 1, totalPages))} src={assets.right_arrow_icon} alt="next" />
            </a>
          </div>
        )}
      </section>
